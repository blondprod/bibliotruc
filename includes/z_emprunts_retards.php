        ...
        $(document).ready(function () {
			...
			var source =
            {
                 ...
                 datafields: [
					 { name: 'id_emprunt'},
					 { name: 'date_emprunt'},
					 { name: 'dateRetour_emprunt'},
					 { name: 'id_livres_emprunt'},
					 { name: 'uid_emprunt'},
					 { name: 'name'},
					 ...
					 { name: 'estSupp_emprunt'}
                ],
				id: 'livres_id',
                url: '../includes/z_emprunts_retards_data.php',
                ...
                updaterow: function (rowid, rowdata, commit) {
                    ...
                    var data = "update=true&date_emprunt=" + rowdata.date_emprunt + "&dateRetour_emprunt=" + rowdata.dateRetour_emprunt + "&id_livres_emprunt=" + rowdata.id_livres_emprunt;
					data = data + "&uid_emprunt=" + rowdata.uid_emprunt + "&name=" + rowdata.name + "&field_numero_tudiant_value=" + rowdata.field_numero_tudiant_value + "&livres_titre=" + rowdata.livres_titre;
					data = data + "&livres_numeroInventaire=" + rowdata.livres_numeroInventaire + "&field_prenom_value=" + rowdata.field_prenom_value + "&field_nom_value=" + rowdata.field_nom_value;
           ...
           // initialize jqxGrid
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                      { text: 'Date de sortie', datafield: 'date_emprunt', width: 110 }
					  , { text: 'Titre du livre', datafield: 'livres_titre', width: 100 }
                      ...
                      , { text: 'Date de retour', datafield: 'dateRetour_emprunt', width: 110 }
					 /* , { text: 'Prof.', datafield: 'field_estprof_value', width: 110 }
					  , { text: 'Caution', datafield: 'field_caution_value', width: 110 }
					  , { text: 'Enveloppes', datafield: 'field_enveloppes_value', width: 110 }*/
                  ]
            });
        });
    </script>
